...
On the other hand is the high GPU usage for the training. The model was trained on 1,000 NVIDIA A100s for two months, in comparison Stable Diffusion was trained [TBD] and DallE was trained [TBD] \
