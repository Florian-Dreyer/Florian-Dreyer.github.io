...
In recent years Generative Artificial Intelligence has gained a lot of popularity. More and more people use it in their daily and professional life. Diffusion Models became popular with models like Stable Diffusion and DALL-E which showed the public what Image Generation using Diffusion Models is able to do. \
...
[Mixture of Experts Explained]([https://arxiv.org/abs/2208.02813](https://huggingface.co/blog/moe))
